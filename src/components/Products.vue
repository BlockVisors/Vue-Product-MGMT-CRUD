<template>
  <div class="products" id="product-container">
    ...
    <div class="jumbotron">
      <h1 class="display-4">Manage Product Inventory</h1>
      <p class="lead">This is a simple application for keeping track of items and prices.
        It can be used for inventory.</p>
      <hr class="my-4">
      <p>It uses It uses Vue and bootstrap with Firebase.</p>
      ...
      <div class="card-body">
        <form class="form-inline" v-on:submit.prevent="onSubmit">
          ...
          <div class="form-group">
            ...
            <input v-model="productData.product_quantity" type="text" class="form-control ml-sm-2 mr-sm-4 my-2" required>
          </div>
            ...
            <tbody>
              <tr v-for="product in sortedProducts" v-bind:key="product.id">
                <template v-if="editId == product.id">
                  ...
                  <td><input v-model="editProductData.product_quantity" type="text"></td>
...
export default {
  ...
  methods: {
    ...
    onEdit(product){
      ...
      this.editProductData.product_quantity = product.product_quantity
    },
    onCancel(){
      this.editId = ''
      ...
      this.editProductData.product_quantity = ''
    },
    onEditSubmit (id){
